...
class User(Base):
    ...
    # Plan tier — cache do workspace.plan_tier (source of truth é workspace)
    plan_tier = Column(
        String(20),
        default="free",
        nullable=False,
        comment="free|solo|team|enterprise — cache, source of truth em workspace"
    )
