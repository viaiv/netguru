...
ENCRYPTED_KEYS = frozenset({
    ...
    "free_llm_api_key_openai",
    "free_llm_api_key_anthropic",
    "free_llm_api_key_google",
    "free_llm_api_key_azure",
    "free_llm_api_key_groq",
    "free_llm_api_key_deepseek",
    "free_llm_api_key_openrouter",
})
